            ...
            <div className="max-w-lg mx-auto">
              ...
              <dl className="mt-8 text-base text-gray-500">
                ...
                <div className="mt-6">
                  ...
                  <dd className="flex">
                    {/* Heroicon name: phone */}
                    <svg className="flex-shrink-0 h-6 w-6 text-red-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <div className="mt-3">
                  ...
                  <dd className="flex">
                    ...
                    <span className="ml-3">
                      info@valerielanelegalnurse.com
                    </span>
                  </dd>
                </div>
              </dl>
          ...
          <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
            <div className="max-w-lg mx-auto lg:max-w-none">
              <form action="#" method="POST" className="grid grid-cols-1 gap-y-6">
                ...
                <div>
                  <button type="submit" className="inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-red-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Submit
                  </button>
                </div>
              </form>
